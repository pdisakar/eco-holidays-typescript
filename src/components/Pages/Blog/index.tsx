...
export default function Blog({ data, siteUrl }: BlogProps) {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < data.block_count; i++) {
      const blocks = (data as any)[`block${i + 1}`];
      if (!blockEls[i] || !blocks) continue;

      blockEls[i].removeAttribute('style');
      blockEls[i].innerHTML = blocks
        .map((itm: any) => {
          const {
            package_title,
            featured,
      ...
      <div className="common-box blog-page pt-0 pb-0">
        <div className="content container">
          <div className="lg:w-2/3 lg:mx-auto">
            ...
            {blogData.abstract && (
              <div
                dangerouslySetInnerHTML={{ __html: blogData.abstract }}></div>
            )}
            ...
            <article
              ...
              id="blog-detail"
              dangerouslySetInnerHTML={{ __html: updatedHtml }}></article>
              ...
              <div className="author-slot mt-10 p-6 rounded-md bg-secondary/[0.065] ">
                <div className="item flex gap-x-6">
                  ...
                  <figcaption>
                    ...
                    {blogData.authors[0].description && (
                      <article
